              ...
              >
                  ...
                  >
                      ...
                      <div style={headerStyle} className={headerClass}>
                          <span>\U0001f5a8 Print Work Order \u2014 {wo.code}</span>
                          ...
                          <div style={{ display: 'flex', gap: '6px' }}>
                              {isClassic ? (
                                  <>
                                      ...
                                      <button style={xpBtnGreen} onClick={() => { const handler = () => onClose(); window.addEventListener('afterprint', handler, { once: true }); window.print(); }}>\U0001f5a8 Print</button>
                                  </>
                              ) : (
                                  <>
                                      <button className="btn btn-sm btn-secondary" onClick={onClose}>Close</button>
                                      <button className="btn btn-sm btn-success" onClick={() => { const handler = () => onClose(); window.addEventListener('afterprint', handler, { once: true }); window.print(); }}>\U0001f5a8 Print</button>
                                  </>
                              )}
                          </div>
                      </div>
